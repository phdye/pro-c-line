...
static unsigned int sqlctx = 1134603;
...
{13,4130,178,0,0,
5,0,0,0,0,0,27,26,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,43,0,6,30,0,0,0,0,0,1,0,
51,0,0,3,60,0,6,34,0,0,0,0,0,1,0,
66,0,0,4,65,0,6,49,0,0,2,2,0,1,0,2,97,0,0,2,3,0,0,
89,0,0,5,0,0,30,68,0,0,0,0,0,1,0,
};
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "begin dbms_output . enable ( NULL ) ; END ;";
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "begin dbms_output . put_line ( 'Hello from Pro*C!' ) ; EN\
D ;";
    sqlstm.iters = (unsigned int  )1;
...

{
        ...
        sqlstm.sqladtp = &sqladt;
        sqlstm.sqltdsp = &sqltds;
        sqlstm.stmt = "begin dbms_output . get_line ( :line:line_ind , :stat\
us ) ; END ;";
        sqlstm.iters = (unsigned int  )1;
        ...
        sqlstm.sqhstl[0] = (unsigned int  )32767;
        sqlstm.sqhsts[0] = (         int  )0;
        sqlstm.sqindv[0] = (         void  *)&line_ind;
        sqlstm.sqinds[0] = (         int  )0;
        sqlstm.sqharm[0] = (unsigned int  )0;
        sqlstm.sqadto[0] = (unsigned short )0;
        sqlstm.sqtdso[0] = (unsigned short )0;
        ...
        sqlstm.sqptdso = sqlstm.sqtdso;
        sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
        if (sqlca.sqlcode < 0) sql_check("dbms_output.get_line");
}
